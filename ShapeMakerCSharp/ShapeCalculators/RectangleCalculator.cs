...
namespace ShapeMakerCSharp
{
	public class RectangleCalculator
	{
            ...
            bool includeBreakdown = false)
        {
            ...
            if (includeBreakdown)
            {
                Console.WriteLine("Rectangle Shapes");
            ...
            Console.WriteLine($"RectangleCalculator produced {shapesFromWinningWordsCount} winning words records and {shapesFromWordsCount} words records in {watch.ElapsedMilliseconds} ms\n");
        ...
        public static List<ShapeModel> Square(
            int interlockWidth,
            ...
            int heightMax)
{
        ...
        public static List<ShapeModel> Rectangle(
            int interlockWidth,
            int interlockHeight,
            in LetterIndexModel letterIndex,
            in List<string> words,
        ...
        public static List<ShapeModel> TopLeftRectangle(
            int interlockWidth,
            int interlockHeight,
            in LetterIndexModel letterIndex,
            in List<string> words,
        ...
        public static List<ShapeModel> TopLeftSquare(
            int interlockWidth,
            in LetterIndexModel letterIndex,
            in List<string> words,
            in List<int> lengths,
        ...
        public static List<ShapeModel> BottomRightRectangle(
            int interlockWidth,
            int interlockHeight,
            in LetterIndexModel letterIndex,
            in List<string> words,
        ...
        public static List<ShapeModel> BottomRightSquare(
            int interlockWidth,
            in LetterIndexModel letterIndex,
            in List<string> words,
            in List<int> lengths,
        ...
        public static List<ShapeModel> TopRightSquare(
            int interlockWidth,
            in LetterIndexModel letterIndex,
            in List<string> words,
            in List<int> lengths,
        ...
        public static List<ShapeModel> TopRightRectangle(
            int interlockWidth,
            int interlockHeight,
            in LetterIndexModel letterIndex,
            in List<string> words,
        ...
        public static List<ShapeModel> BottomLeftRectangle(
            int interlockWidth,
            int interlockHeight,
            in LetterIndexModel letterIndex,
            in List<string> words,
        ...
        public static List<ShapeModel> TopRightRectangleBase(
            int interlockWidth,
            int interlockHeight,
            in LetterIndexModel letterIndex,
            in List<string> words,
