...
public class BranchAndBoundSolutions_Tests
{
    ...
    public void test_executeGamesWinningWords_depth1_width1()
    {
        ...
        List<int> result = BranchAndBoundSolutions.ExecuteGamesWinningWords(gameIds: depth1_width1, lookaheadDepth: 1, beamWidth: 1, maxDepth: 30, rootShape: 0, rootWidth: 1, useGuidedScores: true);
