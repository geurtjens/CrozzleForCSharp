    ...
    public class GameList
    {
        ...
        public static GameModel FindGame(int gameId)
        {
            switch (gameId)
            {
                ...
                new List<string>() { "TOYS", "YULE", "TURKEY", "GUESTS", "SWEETS", "HOLLY", "PLUMS", "PARSLEY", "PORT", "ROAST", "WISHES", "BUSH", "PRESENTS", "SALT", "JELLY", "SUGAR", "NUTMEG", "DATES", "SAUCE", "WINE", "MEAT", "TREE", "EGGS", "SPICE", "FARE" },
                new List<string>() { "TOYS", "YULE", "TURKEY", "GUESTS", "SWEETS", "HOLLY", "PLUMS", "PARSLEY", "PORT", "ROAST", "WISHES", "BUSH", "PRESENTS", "SALT", "JELLY", "SUGAR", "NUTMEG", "DATES", "SAUCE", "WINE", "MEAT", "TREE", "EGGS", "SPICE", "FARE", "NUTS", "GLAZED", "MARZIPAN", "GRAVY", "TOAST", "RUM", "BUTTER", "MIXTURE", "SULTANAS", "TOMATO", "HATS", "BISCUITS", "CURRANTS", "POTATOES", "FRUIT", "BRANDY", "CUSTARD", "ONIONS", "STREAMERS", "GLASSES", "STUFFING", "MISTLETOE", "CELERY", "SILVER", "CASHEWS", "LETTUCE", "LIQUEUR", "RAISINS", "LIGHTS", "LIQUOR", "FLOWERS", "PUMPKIN", "APRICOTS", "FLOUR", "PUNCH", "SEASONING", "BOWL", "PEARS", "GREETINGS", "PORK", "DECORATIONS", "ALMONDS", "CLOTH", "CAROLS", "GRAPES", "VEGETABLES", "FIGS", "BALLOONS", "BASIN", "HERBS", "MIXED", "PUDDING", "MARASCHINO", "BEANS", "CARDS", "LEMON", "MELON", "TRIFLE", "CINNAMON", "CHERRIES", "BANANAS", "CRANBERRIES", "BELLS", "JUICE", "NOEL", "CARAMELS", "ORANGE", "SALAD", "CANDLES", "PEACHES", "PINEAPPLE", "GINGER", "HAM", "CHEESE", "LEMONADE", "CHAMPAGNE", "ICING", "CORDIAL", "LAMB", "PEEL", "CHICKEN", "CHEER", "DRIED", "COFFEE", "ICE", "CAKE", "BEEF" },
                ...
                new List<string>() { "STUTZ", "SUZUKI", "BENZ", "VW", "MAZDA", "VORTEX", "ROCKY", "CAMRY", "SUPRA", "TURBO", "TELSTAR", "ASTRA", "BMW", "RENAULT", "ROLLS", "COLT", "ROMEO", "TARAGO", "AUDI", "MG", "SEDAN", "NOMAD", "SAAB", "GOLF", "ALFA", "LADA" },
                new List<string>() { "STUTZ", "SUZUKI", "BENZ", "VW", "MAZDA", "VORTEX", "ROCKY", "CAMRY", "SUPRA", "TURBO", "TELSTAR", "ASTRA", "BMW", "RENAULT", "ROLLS", "COLT", "ROMEO", "TARAGO", "AUDI", "MG", "SEDAN", "NOMAD", "SAAB", "GOLF", "ALFA", "LADA", "PIAZZA", "TOYOTA", "SPORTS", "PLYMOUTH", "ROYCE", "VOLVO", "AUSTIN", "SUBARU", "SKYLINE", "HYUNDAI", "TORQUE", "CHRYSLER", "BENTLEY", "TRIUMPH", "MINX", "NISSAN", "PULSAR", "MITSUBISHI", "ROVER", "AUTOMATIC", "PEUGEOT", "VAUXHALL", "DAIHATSU", "LEYLAND", "PATROL", "NASH", "NIVA", "MASERATI", "SINGER", "FAIRMONT", "CHEVROLET", "CITROEN", "HARDTOP", "PINTARA", "PONTIAC", "PORSCHE", "EXA", "HUMBER", "MANUAL", "CRESSIDA", "FUEGO", "LASER", "INTEGRA", "FIAT", "JAGUAR", "PRELUDE", "COMMODORE", "MAVERICK", "REGATA", "BUICK", "CIVIC", "HATCH", "SECA", "LINCOLN", "PAJERO", "CABRIOLET", "MERCEDES", "KOMBI", "COROLLA", "FORD", "CALAIS", "FERRARI", "HILLMAN", "HONDA", "MAGNA", "JACKAROO", "HOLDEN", "DARRACQ", "BARINA", "CAMIRA", "CORDIA", "FALCON", "DAIMLER", "LAGONDA", "ACCORD", "FAIRLANE", "LANCIA", "LEGEND", "DODGE", "GHIA", "CHARADE", "CADILLAC", "CELICA" },
                ...
                new List<string>() { "ZAIRE", "CYPRUS", "ZAMBIA", "URUGUAY", "TANZANIA", "BELIZE", "TURKEY", "SYRIA", "ITALY", "GUYANA", "HUNGARY", "YEMEN", "KENYA", "GERMANY", "TOGO", "SUDAN", "PERU", "BURMA", "CUBA", "NIGER" },
                new List<string>() { "ZAIRE", "CYPRUS", "ZAMBIA", "URUGUAY", "TANZANIA", "BELIZE", "TURKEY", "SYRIA", "ITALY", "GUYANA", "HUNGARY", "YEMEN", "KENYA", "GERMANY", "TOGO", "SUDAN", "PERU", "BURMA", "CUBA", "NIGER", "BRAZIL", "SWAZILAND", "SWITZERLAND", "VENEZUELA", "ZIMBABWE", "EGYPT", "NORWAY", "MOZAMBIQUE", "TUVALU", "VANUATU", "YUGOSLAVIA", "RUSSIA", "NAURU", "MAURITIUS", "CZECHOSLOVAKIA", "KUWAIT", "PARAGUAY", "AUSTRIA", "LIBYA", "BOTSWANA", "MALAYSIA", "LUXEMBOURG", "SEYCHELLES", "PORTUGAL", "BHUTAN", "TAIWAN", "BURUNDI", "VIETNAM", "HONDURAS", "SURINAME", "AUSTRALIA", "SWEDEN", "SPAIN", "TONGA", "LAOS", "PAKISTAN", "ANTIGUA", "QATAR", "SAMOA", "DJIBOUTI", "MAURITANIA", "LIECHTENSTEIN", "MALDIVES", "BRUNEI", "MEXICO", "TOBAGO", "SINGAPORE", "NETHERLANDS", "OMAN", "MALTA", "PHILIPPINES", "RWANDA", "BRITAIN", "MOROCCO", "SOMALIA", "GUATEMALA", "AFGHANISTAN", "CONGO", "HAITI", "GUINEA", "ISRAEL", "MALAWI", "MONACO", "ETHIOPIA", "ARGENTINA", "INDONESIA", "CAMEROON", "MONGOLIA", "TRINIDAD", "BELGIUM", "BOLIVIA", "ECUADOR", "ROMANIA", "UGANDA", "IRAN", "IRAQ", "KIRIBATI", "ANDORRA", "SENEGAL", "JORDAN", "POLAND", "NICARAGUA", "BARBADOS", "BULGARIA", "THAILAND", "BAHAMAS", "PANAMA", "DENMARK", "LEBANON", "BENIN", "GABON", "JAPAN", "KOREA", "NEPAL", "MADAGASCAR", "COLOMBIA", "DOMINICA", "ANGOLA", "BANGLADESH", "NIGERIA", "MALI", "BAHRAIN", "FINLAND", "IRELAND", "CHINA", "GHANA", "INDIA", "FRANCE", "GRENADA", "ALGERIA", "LIBERIA", "GAMBIA", "FIJI", "ALBANIA", "ICELAND", "JAMAICA", "GREECE", "CHILE", "CANADA", "CHAD" },
                ...
                new List<string>() { "SQUEEZER", "TRAY", "FREEZER", "SPOONS", "STOOL", "TRIVET", "SIEVES", "BOTTLES", "SAUCERS", "TRAYMOBILE", "GLASS", "TILES", "SHEARS", "SINK", "GAS", "KETTLE", "BASKET", "SCALES", "APRON", "TEA", "FAN" },
                new List<string>() { "SQUEEZER", "TRAY", "FREEZER", "SPOONS", "STOOL", "TRIVET", "SIEVES", "BOTTLES", "SAUCERS", "TRAYMOBILE", "GLASS", "TILES", "SHEARS", "SINK", "GAS", "KETTLE", "BASKET", "SCALES", "APRON", "TEA", "FAN", "PANTRY", "STOVE", "CUTLERY", "SCISSORS", "TROLLEY", "UTENSILS", "FRYPAN", "TOASTER", "WORKTOP", "SWITCH", "TEASPOONS", "COUNTERTOP", "SPATULA", "WINDOW", "CURTAINS", "WATER", "TEAPOT", "TUREEN", "EXTRACTOR", "POWERPOINT", "ROASTER", "SHELVES", "OVEN", "PROCESSOR", "ROTISSERIE", "ELECTRICITY", "KNIVES", "TEATOWEL", "LIGHTS", "STRAINER", "EQUIPMENT", "DRAWERS", "MEASURE", "STEAMER", "NUTCRACKERS", "FORKS", "TIMER", "HOTPLATE", "THERMOMETER", "CONTAINERS", "CONVECTION", "DISHWASHER", "TABLESPOON", "CORKSCREW", "MICROWAVE", "CANISTER", "MATCHES", "SKILLET", "SKIMMER", "CUPBOARDS", "IRON", "SAUCEPAN", "TERRINE", "TENDERISER", "FUNNEL", "GRATER", "CASSEROLE", "PERCOLATOR", "GADGETS", "GASRING", "LIDS", "CABINETS", "RAMEKINS", "BASIN", "LIGHT", "COOKWARE", "FLOOR", "BLINDS", "FILTER", "LIGHTER", "CUPBOARD", "GROCERIES", "TELEPHONE", "AIRCONDITIONER", "REFRIGERATOR", "KITCHEN", "COOKER", "MINCER", "TABLE", "CLEAVER", "GRINDER", "MANDOLINE", "POACHER", "DRAIN", "GRILL", "BOILER", "BARBECUE", "COLANDER", "LARDER", "CLOCK", "BLENDER", "CEILING", "DREDGER", "GRIDDLE", "BENCH", "LADLE" },
                ...
                new List<string>() { "KAZOO", "ZITHER", "WURLITZER", "ZAMPOGNA", "TUDUM", "LYRE", "PSALTERY", "MUSETTE", "SPOONS", "LUTE", "SITAR", "SPINET", "DRUM", "RATTLE", "VIOL", "CORNET", "VIOLIN", "TABOR", "HORN", "PANPIPE", "DARBUK", "HARP", "PIPE", "OBOE", "OCARINA", "CELLO", "FIFE" },
                new List<string>() { "KAZOO", "ZITHER", "WURLITZER", "ZAMPOGNA", "TUDUM", "LYRE", "PSALTERY", "MUSETTE", "SPOONS", "LUTE", "SITAR", "SPINET", "DRUM", "RATTLE", "VIOL", "CORNET", "VIOLIN", "TABOR", "HORN", "PANPIPE", "DARBUK", "HARP", "PIPE", "OBOE", "OCARINA", "CELLO", "FIFE", "SYMPHONIUM", "TRUMPET", "XYLOPHONE", "QUINTON", "CYMBALS", "CASTANETS", "SAXHORN", "WHISTLE", "SOUSAPHONE", "BASSOON", "VIOLETTA", "GUITAR", "GITTERN", "SACKBUT", "EUPHONIUM", "FLUTE", "AUTOHARP", "SAXOPHONE", "CONTRABASS", "KETTLEDRUM", "COMPONIUM", "TROMBONE", "TAMBOURINE", "TIMPANI", "MANDOBASS", "CORNO", "VIOLA", "TIMBALES", "FLEXATONE", "CELESTE", "CLAPPERS", "VIRGINAL", "KONIGHORN", "VIOLONCELLO", "GONG", "ORGAN", "PIANO", "SHAKER", "ALPHORN", "TRIANGLE", "FLUGELHORN", "HARPSICHORD", "CLARINET", "DULCIMER", "MARACAS", "LIRONE", "RACKET", "BUGLE", "MANDOLIN", "COWBELL", "SHIELD", "BOMBARDON", "MELODEON", "CLAVICHORD", "PICCOLO", "HARMONICA", "CARILLON", "RECORDER", "ACCORDION", "FLAGEOLET", "GADULKA", "UKELELE", "BANJO", "DIDGERIDOO", "GEKKIN", "BAGPIPE", "CALLIOPE", "BANJOLELE", "ALBOKA", "HANDBELL", "CRECELLE", "BELL", "BALALAIKA", "FIDDLE" },
                ...
                new List<string>() { "ZIGZAGGER", "ZIPPERS", "CUT", "WOOLS", "SATINS", "VELVETS", "CROSS", "PRESS", "TUCK", "WELT", "ADJUST", "MUSLIN", "WORK", "SEAMS", "ART", "SLEEVES", "PLEATS", "CANVAS", "WEAVE", "WEAVING", "TIE", "DRAWN", "IRON", "PIN", "RAISE", "BIAS", "DIOR", "PIPED", "WELDED", "REEL", "LACE" },
                new List<string>() { "ZIGZAGGER", "ZIPPERS", "CUT", "WOOLS", "SATINS", "VELVETS", "CROSS", "PRESS", "TUCK", "WELT", "ADJUST", "MUSLIN", "WORK", "SEAMS", "ART", "SLEEVES", "PLEATS", "CANVAS", "WEAVE", "WEAVING", "TIE", "DRAWN", "IRON", "PIN", "RAISE", "BIAS", "DIOR", "PIPED", "WELDED", "REEL", "LACE", "TAPESTRY", "VESTMENTS", "SCISSORS", "BRUSSELS", "EYELET", "PATTERNS", "STITCHES", "TATTING", "BUTTONHOLES", "KNOT", "DARTS", "DRESS", "OVERCAST", "SEWING", "POCKETS", "RUNNING", "GARMENTS", "KNITTING", "QUILTING", "WAISTLINE", "MEASUREMENT", "MONOGRAMS", "FITTING", "DRESSMAKERS", "PUNCH", "EMBROIDERY", "HEMS", "GATHERS", "VENETIAN", "ARRAS", "BOUND", "RUFFLES", "SHIRRING", "SMOCKING", "MOSAIC", "RHODES", "ELASTIC", "TAILORING", "GODET", "INTERLINING", "RENAISSANCE", "HANGINGS", "CRAFT", "MOIRE", "SHELL", "DESIGN", "CROCHET", "GOBELINS", "MATERIAL", "TACKING", "THIMBLE", "BRAIDS", "CREWEL", "NAPKIN", "THREAD", "BATIK", "INTERFACING", "FILLET", "DECORATE", "LINEN", "ARMHOLE", "DARNING", "FEATHER", "NEEDLES", "RICHELIEU", "MEND", "FANCIFUL", "PINKED", "CANDLEWICK", "BRODERIE", "BOBBIN", "LAPPED", "BARGELLO", "DELICATE", "CHAIN", "MADEIRA", "FABRIC", "EDGE" },
